...
La clase Loan además cuenta con una función que siguiendo la descripción del flujo de estátuses de una solicitud, devuelve los posibles siguientes estatus de una solicitud en función de su estatus actual. Si es Pendiente será una lista con Aprobado y Rechazado, y si es Aprobado será una lista con Cancelado; en cualquier de los otros casos devuelve una lista vacía. Esta información es utilizada a la hora de permitir al gestor cambiar el estado de una solicitud de préstamo.
